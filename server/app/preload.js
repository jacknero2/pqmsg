...
contextBridge.exposeInMainWorld('srv', {
  ...
  setPublish: (patch) => ipcRenderer.invoke('set-publish', patch),
  ...
  masterReset: () => ipcRenderer.invoke('master-reset'),
  masterResetVerify: (challengeId, code, newPassword) => ipcRenderer.invoke('master-reset-verify', { challengeId, code, newPassword }),
